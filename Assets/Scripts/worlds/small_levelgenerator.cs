    ...
    void FixedUpdate()
    {
        ...
        if (randomNumber > 0.96f - difficulty * 0.0001f)
        {
            ...
            if (randomNumber > 0.98f)
            {
                ...
                ppipe.transform.rotation = Quaternion.identity;
                ppipe.transform.position = new Vector3(Random.Range(-4, 4f), 1, 36);
                Rigidbody m_Rigidbody = ppipe.GetComponent<Rigidbody>();
                m_Rigidbody.velocity = new Vector3(0, 0, -15f);
            }
            else if (randomNumber>0.975f && randomNumber<0.98f)
            {
                ...
                watero.transform.position = new Vector3(Random.Range(-4, 4f), .010f, 36);
            ...
            else if (randomNumber>0.96f && randomNumber<0.98f)
            {
                ...
                mpipeo.transform.position = new Vector3(Random.Range(-4, 4f), .010f, 36);
            ...
            else
            {
                ...
                if (wallRandom > 0.5)
                {
                    ...
                    ppipe.transform.position = new Vector3(Random.Range(-4, 4f), 1f, 36);
                }
                else
                {
                    ppipe.transform.position = new Vector3(Random.Range(-4, 4f),0.8f, 36);
                }
                ppipe.transform.rotation = Quaternion.identity;
